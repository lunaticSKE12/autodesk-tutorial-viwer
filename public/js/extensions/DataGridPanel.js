const DATAGRID_CONFIG = {
    requiredProps: ['name', 'Volume', 'Level', 'NUM_CO2'], // Which properties should be requested for each object
    ...
    createRow: (dbid, name, props) => { // Function generating grid rows based on recieved object properties
        ...
        const co2 = props.find(p => p.displayName === 'NUM_CO2')?.displayValue;
        return { dbid, name, volume, level, co2 };
    },
