  ...
  onToolbarCreated() {
    ...
    this._button.onClick = (ev) => {
      ...
      this.getAllLeafComponents((dbIds) => {
        ...
        console.log(dbIds);
        const filteredProps = ["NUM_CO2","Type Name"];
        ...
        this.viewer.model.getBulkProperties(dbIds, filteredProps, (items) => {
          ...
          items.forEach((item) => {
            ...
            item.properties.forEach(function (prop) {
              ...
              if (
                filteredProps[prop.displayName][prop.displayValue] === undefined
              )
                filteredProps[prop.displayName][prop.displayValue] = 1;
              else filteredProps[prop.displayName][prop.displayValue] += 1;
            });
          });
          // Now ready to show!
